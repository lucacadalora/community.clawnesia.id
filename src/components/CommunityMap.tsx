...
export function CommunityMap() {
  return (
    <section className="section-shell bg-slate text-cream">
      <div className="section-inner-wide">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          ...
          <ScrollReveal delay={0.1} className="min-w-0">
            <div className="grid-overlay relative w-full max-w-full overflow-hidden rounded-[32px] border border-[#363230] bg-slate-card p-6 shadow-card">
              ...
              <div className="relative grid gap-5 md:grid-cols-2">
                {["Telegram aktif", "Workshop bulanan", "Sharing builder", "Review use case"].map(
                  (item) => (
                    <div
                      key={item}
                      className="rounded-[24px] border border-[#363230] bg-slate-card p-5"
                    >
                      <p className="font-heading text-h5 text-cream">{item}</p>
        ...
        <div className="mt-12">
          <Marquee
            className="border-y border-[#363230] py-5"
            trackClassName="font-heading text-h4 text-cream/60 md:text-h3"
